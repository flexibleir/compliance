...
type CreateCreated struct {
	...
	/*
	  In: Body
	*/
	Payload *models.Createjob `json:"body,omitempty"`
}
...
func (o *CreateCreated) WithPayload(payload *models.Createjob) *CreateCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create created response
func (o *CreateCreated) SetPayload(payload *models.Createjob) {
	o.Payload = payload
}
